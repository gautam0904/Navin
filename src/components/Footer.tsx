...
export const Footer: React.FC<FooterProps> = ({
  ...
  return (
    <div className="mt-8 bg-bg-secondary dark:bg-bg-secondary rounded-lg shadow-md p-8 text-center border border-primary/20 dark:border-primary/20 transition-colors card" style={{ padding: 'var(--space-xl)' }}>
      {isComplete ? (
        ...
        <div className="space-y-4">
          ...
          <p className="text-lg text-text-secondary dark:text-text-secondary font-semibold">Keep going! You're doing great.</p>
        </div>
      )}
          ...
          <div className="max-w-2xl mx-auto space-y-3">
            ...
            <ol className="text-sm text-text-secondary dark:text-text-secondary space-y-2 text-left">
              ...
              <li className="flex gap-2">
                ...
                <span>Open <code className="bg-bg-surface-2 dark:bg-bg-surface-2 px-2 py-0.5 rounded border border-border-medium dark:border-border-medium shadow-sm">src/data/defaultChecklist.ts</code> in your editor</span>
              </li>
              <li className="flex gap-2">
                <span className="font-bold text-primary dark:text-accent">4.</span>
                <span>Find the <code className="bg-bg-surface-2 dark:bg-bg-surface-2 px-2 py-0.5 rounded border border-border-medium dark:border-border-medium shadow-sm">defaultChecklistData</code> array</span>
              </li>
              <li className="flex gap-2">

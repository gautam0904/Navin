...
import { Globe, Plus, Trash2, Download, Upload, RefreshCw, MoreVertical } from 'lucide-react';
import { useGit } from '../../contexts/GitContext';

export function RemotePanel() {
    const { remotes, refreshRemotes, addRemote, removeRemote, fetchRemote, pushToRemote, pullFromRemote, branches } = useGit();
        ...
        <div className="flex flex-col h-full bg-[#1e1e1e] text-white">
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar p-2 space-y-2">
                {!remotes || remotes.length === 0 ? (
                    ...
                    remotes.map((remote) => (
                        <div key={remote.name} className="bg-[#2a2d2e] rounded border border-[#3c3c3c] overflow-hidden">

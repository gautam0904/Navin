    ...
    <div className="space-y-2">
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-8 pr-8 py-1.5 text-xs rounded-md border border-[--git-panel-border] bg-[--color-bg-primary] text-[--color-text-primary] focus:outline-none focus:ring-1 focus:ring-[--color-primary] placeholder:text-[--color-text-tertiary]"
        />
        {searchQuery && (
          <button
            onClick={() => handleSearchChange('')}
            className="absolute right-2 top-1/2 -translate-y-1/2 p-0.5 hover:bg-[--color-bg-surface-2] rounded transition-colors"
          >
      ...
      <div className="flex items-center gap-1.5">
        <Filter className="w-3 h-3 text-[--color-text-tertiary] shrink-0" />

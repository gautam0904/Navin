...
export function DeleteConfirm({ branchName, onConfirm, onCancel }: DeleteConfirmProps) {
  return (
    <div className="p-4 bg-[rgba(239,68,68,0.1)] border-b border-[var(--color-error)] animate-slide-in">
      <div className="flex items-start gap-3">
        <div className="w-8 h-8 rounded-lg bg-[var(--color-error)] flex items-center justify-center shrink-0">

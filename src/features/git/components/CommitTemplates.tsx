...
export const COMMIT_TEMPLATES: CommitTemplate[] = [
    {
        ...
        template: 'fix: resolve issue with [component/feature]\n\n- Fixed [specific issue]\n- Added error handling\n- Updated tests',
    ...
    },
    {
        ...
        template: 'refactor: improve [component/module]\n\n- Extracted [functionality]\n- Improved [aspect]\n- Updated tests',
    ...
    },
    {
        ...
        template: 'chore: update [dependencies/config]\n\n- Updated [dependency]\n- Fixed [configuration]\n- Improved [tooling]',
                        ...
                        {COMMIT_TEMPLATES.map((template) => (
                            ...
                            >
                                ...
                                <div className="flex-1 min-w-0">
                                    <div className="text-xs font-medium text-[--color-text-primary]">{template.name}</div>
                                    <div className="text-[10px] text-[--color-text-tertiary]">{template.description}</div>
                                </div>
                            </button>
                        ))}
                    </div>

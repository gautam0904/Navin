    ...
    return (
        <div className="flex flex-col h-full bg-[#1e1e1e] text-white overflow-hidden">
            <div className="flex items-center justify-between p-3 border-b border-[#333]">
                <h2 className="font-semibold text-sm uppercase tracking-wider text-gray-400">Commit History</h2>
                ...
                <div className="divide-y divide-[#2a2d2e]">
                    {history.map((commit) => (
                        <div
                            ...
                            className={`group p-3 cursor-pointer hover:bg-[#2a2d2e] transition-colors ${selectedSha === commit.sha ? 'bg-[#2a2d2e] border-l-2 border-[#007fd4]' : 'border-l-2 border-transparent'
                                }`}
                        >
                            <div className="flex items-start gap-3">
                                <div className="mt-1">
                                    <GitCommit className={`w-4 h-4 ${selectedSha === commit.sha ? 'text-[#007fd4]' : 'text-gray-500'}`} />
                                </div>

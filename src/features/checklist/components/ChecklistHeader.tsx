...
export const ChecklistHeader: React.FC<ChecklistHeaderProps> = ({ currentProject }) => {
  return (
    <div className="flex flex-wrap items-center gap-2 sm:gap-3">
      <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-primary rounded-lg shadow-md">
        <ClipboardList className="w-4 h-4 sm:w-5 sm:h-5 shrink-0" />
        <span className="text-xs text-text-primary dark:text-text-primary sm:text-sm font-bold ">

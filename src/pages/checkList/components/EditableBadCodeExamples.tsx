...
import { Code2, X, Plus, Trash2, Edit2, Save } from 'lucide-react';
import { CodeExample, LANGUAGES } from '../../../types/checklist';
import { CodeEditor } from './CodeEditor';

interface EditableBadCodeExamplesProps {
  examples: Array<CodeExample>;
  onExamplesChange: (examples: Array<CodeExample>) => void;
  onSave: () => void;
}

export const EditableBadCodeExamples: React.FC<EditableBadCodeExamplesProps> = ({
  examples,
  onExamplesChange,
  onSave,
}) => {

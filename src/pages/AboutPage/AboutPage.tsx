  ...
  return (
    <div className="max-w-4xl mx-auto space-y-4 sm:space-y-6">
      ...
      <div className="bg-bg-secondary dark:bg-bg-secondary rounded-lg shadow-md p-4 sm:p-6 space-y-4 sm:space-y-6 border border-border-light dark:border-border-medium transition-colors">
        <section>
          <h2 className="text-lg sm:text-xl font-semibold text-text-primary dark:text-text-primary mb-3 sm:mb-4">
            About Navin
          </h2>
          <p className="text-sm sm:text-base text-text-secondary dark:text-text-secondary leading-relaxed">
            Navin is a developer checklist application designed to help maintain code quality and
            follow best practices throughout the development lifecycle. It provides a comprehensive
            checklist covering branch naming, API handling, code quality, performance, testing, and
            more.
          </p>
        </section>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
            <div className="p-3 sm:p-4 bg-bg-primary dark:bg-pickled-bluewood/30 rounded-lg border border-border-light dark:border-border-medium">
              <h3 className="font-semibold text-sm sm:text-base text-text-primary dark:text-text-primary mb-2">
                Frontend
              </h3>

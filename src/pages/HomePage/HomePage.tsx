...
const features: Feature[] = [
  {
    ...
    description:
      'Covering branch naming, API handling, code quality, testing, and more. Each section includes detailed items to ensure best practices are followed.',
  },
  {
    id: 'storage',
    icon: Database,
    ...
    description:
      'Your progress is saved locally using SQLite database. All checklist states and project data persist across app restarts.',
  },
  {
    id: 'admin',
    icon: Shield,
    title: 'Admin Mode',
    description:
      'Edit and customize checklist items to fit your workflow. Add new sections, modify existing items, and save changes to your codebase.',
  },
  {
    id: 'projects',
    icon: FolderTree,
    title: 'Project-Based',
    description:
      'Each project has its own checklist criteria and progress tracking. Switch between projects seamlessly while maintaining separate progress.',
  },
];
        ...
        {currentProject && (
          <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-primary/5 dark:bg-primary/10 rounded border border-primary/20 dark:border-primary/30 text-sm">
            ...
            <span className="font-medium text-primary dark:text-accent">
              <span className="text-text-secondary dark:text-text-secondary">Project:</span>{' '}
              {currentProject.name}
            </span>
          </div>
        )}
              ...
              <div key={feature.id} className="group">
                ...
                >
                  <div className="flex items-center gap-2 shrink-0">
                    ...
                    <Icon
                      className={`w-4 h-4 sm:w-5 sm:h-5 text-primary dark:text-accent transition-transform shrink-0 ${isExpanded ? 'scale-110' : 'group-hover:scale-105'}`}
                    />
                  </div>

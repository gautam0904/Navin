  ...
  return (
    <div className="max-w-4xl mx-auto space-y-4 sm:space-y-6">
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        <h1 className="text-2xl sm:text-3xl font-bold text-text-primary dark:text-text-primary">Settings</h1>
      </div>
      ...
      <div className="bg-bg-secondary dark:bg-bg-secondary rounded-xl shadow-sm p-4 sm:p-6 space-y-4 sm:space-y-6 border border-border-light dark:border-border-medium transition-colors">
        <section>
          <div className="flex items-center gap-2 mb-3 sm:mb-4">
            ...
            <h2 className="text-lg sm:text-xl font-semibold text-text-primary dark:text-text-primary">Database</h2>
          </div>
          <div className="space-y-3">
            <div className="flex items-center justify-between p-3 sm:p-4 bg-bg-surface-2 dark:bg-bg-surface-2 rounded-lg border border-border-light dark:border-border-medium shadow-sm">
              <div>
                <p className="font-semibold text-sm sm:text-base text-text-primary dark:text-text-primary mb-1">Database Location</p>
                <p className="text-xs sm:text-sm text-text-secondary dark:text-text-secondary">Stored locally in app data directory</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section>
          <div className="flex items-center gap-2 mb-3 sm:mb-4">
            ...
            <h2 className="text-lg sm:text-xl font-semibold text-text-primary dark:text-text-primary">Data Management</h2>
          </div>
          <div className="space-y-3">
            <button
        ...
        <section>
          <div className="flex items-center gap-2 mb-3 sm:mb-4">
            ...
            <h2 className="text-lg sm:text-xl font-semibold text-text-primary dark:text-text-primary">Data Portability</h2>
          </div>
          <div className="space-y-3">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              ...
              >
                ...
                <span className="font-semibold text-sm sm:text-base">{isExporting ? 'Exporting...' : 'Export to JSON'}</span>
              </button>
              <button
              ...
              >
                ...
                <span className="font-semibold text-sm sm:text-base">{isImporting ? 'Importing...' : 'Import from JSON'}</span>
              </button>
            </div>
            <button
            ...
            >
              ...
              <span className="font-semibold text-sm sm:text-base">{isImporting ? 'Importing...' : 'Import from Clipboard'}</span>
            </button>
            <button
              onClick={() => {
        ...
        <section>
          <div className="flex items-center gap-2 mb-3 sm:mb-4">
            ...
            <h2 className="text-lg sm:text-xl font-semibold text-text-primary dark:text-text-primary">Projects</h2>
          </div>
          <div className="space-y-3">
            <p className="text-xs sm:text-sm text-text-secondary dark:text-text-secondary">
        ...
        {isAdminMode && (
          <section>
            <div className="flex items-center gap-2 mb-3 sm:mb-4">
              ...
              <h2 className="text-lg sm:text-xl font-semibold text-text-primary dark:text-text-primary">Admin Mode</h2>
            </div>
